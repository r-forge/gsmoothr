...
See the \textt{multiHeatmap} example and documentation for the creating multi-panel heatmaps allowing complete control over colour scales and spacing between.  
